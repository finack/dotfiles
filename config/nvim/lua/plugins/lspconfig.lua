    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Enable native completion (Neovim 0.12+)
          ...
          vim.keymap.set('n', '<leader>cn', vim.lsp.buf.rename, { buffer = bufnr, desc = 'LSP: [R]e[n]ame' })

          -- Execute a code action, usually your cursor needs to be on top of an error
          -- or a suggestion from your LSP for this to activate.
          vim.keymap.set({ 'n', 'x' }, '<leader>ca', vim.lsp.buf.code_action, { buffer = bufnr, desc = 'LSP: [C]ode [A]ction' })

          -- Find references for the word under your cursor.
          vim.keymap.set('n', '<leader>cr', function()
            Snacks.picker.lsp_references()
          end, { buffer = bufnr, desc = 'LSP: [C]ode [R]eferences' })

          -- Jump to the implementation of the word under your cursor.
          --  Useful when your language has ways of declaring types without an actual implementation.
          vim.keymap.set('n', '<leader>ci', function()
            Snacks.picker.lsp_implementations()
          end, { buffer = bufnr, desc = 'LSP: [C]ode [I]mplementation' })
          ...
          end, { buffer = bufnr, desc = 'LSP: [C]ode [D]efinition' })

          -- WARN: This is not Goto Definition, this is Goto Declaration.
          --  For example, in C this would take you to the header.
          vim.keymap.set('n', '<leader>cD', vim.lsp.buf.declaration, { buffer = bufnr, desc = 'LSP: [C]ode [D]eclaration' })

          -- Fuzzy find all the symbols in your current document.
          --  Symbols are things like variables, functions, types, etc.
          vim.keymap.set('n', '<leader>cO', function()
            Snacks.picker.lsp_symbols()
          end, { buffer = bufnr, desc = 'LSP: [C]ode D[O]cument Symbols' })

          -- Fuzzy find all the symbols in your current workspace.
          --  Similar to document symbols, except searches over your entire project.
          vim.keymap.set('n', '<leader>cW', function()
            Snacks.picker.lsp_workspace_symbols()
          end, { buffer = bufnr, desc = 'LSP: [C]ode [W]orkspace Symbols' })
          ...
          end, { buffer = bufnr, desc = 'LSP: [C]ode [T]ype Definition' })
